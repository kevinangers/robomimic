...
class BaseConfig(Config):
    ...
    def observation_config(self):
        ...
        self.observation.encoder.rgb.core_kwargs = Config()                     # See models/base_nets.py (models/obs_core.py from master) for important kwargs to set and defaults used
        ...
        self.observation.encoder.rgb.obs_randomizer_kwargs = Config()           # See models/base_nets.py (models/obs_core.py from master) for important kwargs to set and defaults used
        ...
        self.observation.encoder.scan.core_kwargs = Config()                    # See models/base_nets.py (models/obs_core.py from master) for important kwargs to set and defaults used
